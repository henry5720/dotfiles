...
bash script/ubuntu/install-tools.sh   # 可選:fastfetch / btop / nvm / code-server / tailscale / wakatime / herdr / gh
bash script/ubuntu/install-tools-ai.sh # Claude Code / Codex / OpenCode / 文件影音 / AI 解析 / codegraph / agent-config(chezmoi apply 之後)
